package com.springboot.efficient.developement.springboot.efficient.developement.controller;
...
public class UploadController {
	...
	@Value("${multipart.location}") // here i am injecting property multipart.location into location
